...
<script type="text/javascript">
	...
	function openChild(){
		...
		place_name = document.getElementById('name').value;
		openWin = window.open("/deli/place/category.dlv?name="+place_name,"childForm","width=500,height=400,resizable=no,scrollbars=no")
	}
                  ...
                  <tr>
              	 ...
              	 <tr>
                        <c:forEach items="${cal}" var="cal">
                            <th><input type="radio" name = "name" value="${cal.name}" id="name"/></th>
                            <th>${cal.name}</th>
                             <th>${cal.address}</th>
                            <th>${cal.distance}</th>
                  </tr>
                            ...
                            <input type="submit" value="확인" onclick="openChild()"/>
                            </form>
